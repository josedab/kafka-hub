...
export const RULE_METADATA: Record<string, DiagnosticRuleMetadata> = {
...
min.insync.replicas=2`,
  ...
  "replication-factor-too-low": {
    title: "replication.factor=2 is below the recommended minimum",
...
min.insync.replicas=2`,
  ...
  "auto-leader-rebalance-disabled": {
    title:
      "auto.leader.rebalance.enable=false leaves leaders unbalanced after recovery",
    example: `# broker
broker.id=1
...
num.partitions=3`,
  ...
  "num-network-threads-low": {
    title: "num.network.threads=2 is below the default",
    example: `# broker
broker.id=1
...
socket.send.buffer.bytes=102400`,
  ...
  "num-io-threads-low": {
    title: "num.io.threads=4 is below the default",
    example: `# broker
broker.id=1
num.io.threads=4
...
default.replication.factor=3`,
  ...
  "broker-id-vs-cluster-id": {
    title: "broker.id=0 is a reserved-looking value",
    example: `# broker
broker.id=0
listeners=SSL://:9093
default.replication.factor=3
...
delete.retention.ms=86400000`,
  ...
  "compact-and-delete-mixed": {
    title:
      "cleanup.policy=compact,delete combines compaction with time-based deletion",
    example: `# topic
...
delete.retention.ms=86400000`,
  ...
  "min-cleanable-dirty-ratio-too-high": {
    title: "min.cleanable.dirty.ratio=0.95 delays compaction excessively",
    example: `# topic
cleanup.policy=compact
...
delete.retention.ms=86400000`,
  ...
  "delete-retention-ms-too-low": {
    title:
      "delete.retention.ms=30000 (< 1h) may drop tombstones before slow consumers see them",
    example: `# topic
cleanup.policy=compact
segment.ms=3600000
...
min.cleanable.dirty.ratio=0.5`,
  ...
  "num-partitions-too-many": {
    title: "num.partitions=2000 as a broker default is excessive",
    example: `# broker defaults
broker.id=1
num.partitions=2000
default.replication.factor=3
auto.create.topics.enable=false`,
  ...
  "enable-idempotence-vs-acks": {
    title: "enable.idempotence=true requires acks=all (got acks=1)",
    example: `# producer
enable.idempotence=true
acks=1
...
acks=all`,
  ...
  "batch-size-tiny": {
    title: "batch.size=8192 is below default and may cap throughput",
    example: `# producer
batch.size=8192
compression.type=zstd
linger.ms=5
...
acks=all`,
  ...
  "max-block-ms-low": {
    title: "max.block.ms=1000 is aggressive and will surface ProducerSendBlockedException",
    example: `# producer
max.block.ms=1000
...
max.poll.records=500`,
  ...
  "max-poll-interval-low": {
    title: "max.poll.interval.ms=30000 is short for any non-trivial processing",
    example: `# consumer
